...
exports.getExistingNavamsaka = getExistingNavamsaka;
exports.getExistingDasha = getExistingDasha;
...
function getExistingPlanetHouse(userId, isLLM) {
...
function getExistingNavamsaka(userId, isLLM) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getExistingDasha(userId, isLLM) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const allMahadashas = savedRecords.map(record => ({
            dasha: record.dashawa,
            from: record.From,
            to: record.To
        }));
...
function getExistingAntardasha(userId, isLLM) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const allAntardashas = antarRecords.map(rec => ({
            anthardhashawa: rec.anthardhashawa,
            setNo: rec.setNo,
            from: rec.From,
            to: rec.To
        ...
        const responseData = {
            ...
            all_antardashas: allAntardashas,
        };
        if (isLLM) {
            return responseData;
        }
