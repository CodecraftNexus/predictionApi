...
const PlanetHouseController_1 = require("./PlanetHouseController");
    ...
    static getUserAnswers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                inspector_1.console.error('Error fetching answers:', error);
                return res.status(500).json({
                    success: false,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const [questionKey, value] of Object.entries(answers)) {
                    ...
                    if (!question) {
                        inspector_1.console.warn(`Question not found: ${questionKey}`);
                        continue;
                    }
                    const answerData = {
                ...
                inspector_1.console.error('Error saving answers:', error);
                return res.status(500).json({
                    success: false,
    ...
    static getDeceasedFamily(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                inspector_1.console.error('Error fetching deceased family members:', error);
                return res.status(500).json({
                    success: false,
    ...
    static saveDeceasedFamily(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                inspector_1.console.error('Error saving deceased family members:', error);
                return res.status(500).json({
                    success: false,
    ...
    static deleteDeceasedMember(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                inspector_1.console.error('Error deleting deceased family member:', error);
                return res.status(500).json({
                    success: false,
    ...
    static getFeedbackStatus(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                inspector_1.console.error('Error fetching feedback status:', error);
                return res.status(500).json({
                    success: false,
    ...
    static getFeedbackStatistics(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                inspector_1.console.error('Error fetching statistics:', error);
                return res.status(500).json({
                    success: false,
    ...
    static getAllFeedbacks(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            `;
                ...
                const userIds = userResults.map(row => row.userId);
                if (userIds.length === 0) {
                    return res.json({
                        success: true,
                        data: [],
                ...
                for (const uid of userIds) {
                    ...
                    const planetId = yield db_1.db.Predictions.findAll({
                        where: { userId: uid },
                        attributes: ["PredictionPlanetId"]
                    });
                    const planetIds = planetId.map((item) => item.PredictionPlanetId);
                    const allPredictions = [];
                    for (const id of planetIds) {
                        const prediction = yield (0, predictionController_1.getExistingPredictions)(uid, "", id, true);
                        allPredictions.push(prediction);
                    }
                    const PlanetHouse = yield (0, PlanetHouseController_1.getExistingPlanetHouse)(uid, true);
                    const Navamsaka = yield (0, PlanetHouseController_1.getExistingNavamsaka)(uid, true);
                    const AstroData = yield (0, PlanetHouseController_1.getExistingAstrologicalDetails)(uid, true);
                    const mahadasha = yield (0, PlanetHouseController_1.getExistingDasha)(uid, true);
                    const AntharDasha = yield (0, PlanetHouseController_1.getExistingAntardasha)(uid, true);
                    const answers = yield models_1.UserFeedbackAnswer.findAll({
                        where: { userId: uid },
                        include: [{
                                model: models_1.UserFeedbackQuestion,
                ...
                inspector_1.console.error('Error fetching all feedbacks:', error);
                return res.status(500).json({
                    success: false,
