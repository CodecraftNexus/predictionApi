...
const savePlanetHouseFromApi = (userId, apiResponse) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!created) {
        ...
        if (planetHouse.box1 !== planetHouseData.box1) {
            updates.box1 = planetHouseData.box1;
        }
        if (planetHouse.box2 !== planetHouseData.box2) {
            updates.box2 = planetHouseData.box2;
        }
        if (planetHouse.box3 !== planetHouseData.box3) {
            updates.box3 = planetHouseData.box3;
        }
        if (planetHouse.box4 !== planetHouseData.box4) {
            updates.box4 = planetHouseData.box4;
        }
        if (planetHouse.box5 !== planetHouseData.box5) {
            updates.box5 = planetHouseData.box5;
        }
        if (planetHouse.box6 !== planetHouseData.box6) {
            updates.box6 = planetHouseData.box6;
        }
        if (planetHouse.box7 !== planetHouseData.box7) {
            updates.box7 = planetHouseData.box7;
        }
        if (planetHouse.box8 !== planetHouseData.box8) {
            updates.box8 = planetHouseData.box8;
        }
        if (planetHouse.box9 !== planetHouseData.box9) {
            updates.box9 = planetHouseData.box9;
        }
        if (planetHouse.box10 !== planetHouseData.box10) {
            updates.box10 = planetHouseData.box10;
        }
        if (planetHouse.box11 !== planetHouseData.box11) {
            updates.box11 = planetHouseData.box11;
        }
        if (planetHouse.box12 !== planetHouseData.box12) {
