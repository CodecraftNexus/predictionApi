...
exports.logout = exports.googleLogin = exports.refreshToken = exports.Login = exports.Register = void 0;
...
exports.googleLogin = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user = yield db_1.db.Users.findOne({ where: { email } });
    if (!user) {
        user = yield db_1.db.Users.create({
            email: email,
