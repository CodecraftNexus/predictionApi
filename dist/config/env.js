...
const ENV = zod_1.z.object({
    ...
    PLANET_HOUSE_API_URL: zod_1.z.string(),
    MAHADASHA_API_URL: zod_1.z.string(),
    ANTHARDASHA_API_URL: zod_1.z.string(),
    LIFETIME_PREDICTION_API_URL: zod_1.z.string(),
    NAVANSHAKA_API_URL: zod_1.z.string(),
    ASCTROLOGIC_DATA_API_URL: zod_1.z.string(),
    DAILY_PREDICTION_API_URL: zod_1.z.string(),
    WEEKLY_PREDICTION_API_URL: zod_1.z.string(),
