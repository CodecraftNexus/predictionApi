...
function initUserRelationship(models) {
    const { User, RefreshToken, OAuthAccount, PalentHouse, DashaBalance, AntharDasha, Predictions, Educationqualifications, Jobs, EducationqualificationsItem, JobsItem, ProfileImage, Navamsaka, AstrologicalDetails } = models;
    if (!User)
        return;
    if (OAuthAccount) {
