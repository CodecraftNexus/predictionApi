...
const HoroscopeRoute_1 = __importDefault(require("./routes/HoroscopeRoute"));
const predictionRoute_1 = __importDefault(require("./routes/predictionRoute"));
const AdminRoute_1 = __importDefault(require("./routes/AdminRoute"));
const UserFeedbackroute_1 = __importDefault(require("./routes/UserFeedbackroute"));
...
app.use("/api/horoscope", HoroscopeRoute_1.default);
app.use("/api/prediction", predictionRoute_1.default);
app.use("/api/admin", AdminRoute_1.default);
app.use("/api", UserFeedbackroute_1.default);
